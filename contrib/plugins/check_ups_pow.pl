...
$oid_upstype = ".1.3.6.1.4.1.534.1.1.2.0";
$oid_battery_capacity = ".1.3.6.1.4.1.534.1.2.4.0";
$oid_output_status = ".1.3.6.1.4.1.534.1.4.5.0";
$oid_output_current = ".1.3.6.1.4.1.534.1.4.4.1.3.0";
$oid_output_load = ".1.3.6.1.4.1.534.1.4.1.0";
$oid_temperature = ".1.3.6.1.4.1.534.1.6.1.0";
