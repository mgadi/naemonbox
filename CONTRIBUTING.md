# Contributing to NaemonBox

Looking to contribute something to NaemonBox ? **Here's how you can help.**
...
The [issue tracker](https://github.com/mgadi/naemonbox/issues) is
the preferred channel for [bug reports](#bug-reports), [features requests](#feature-requests)
and [submitting pull requests](#pull-requests), but please respect the following
restrictions:

* Please **do not** use the issue tracker for personal support requests. A official Q&A exist. [Use it](https://groups.google.com/forum/?hl=en#!forum/naemonbox-users) ! 
...
When contributing to NaemonBox's documentation, you should edit the
documentation source files in
[the `/doc/` and `/man/` directories of the `develop` branch](https://github.com/mgadi/naemonbox/tree/Develop/doc).
...
1. [Fork](https://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/naemonbox.git
   # Navigate to the newly cloned directory
   cd naemonbox
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/mgadi/naemonbox.git
   ```
